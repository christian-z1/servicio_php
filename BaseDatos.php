...
// alberto christian hernandez medina
//  abril 2020 
//---------------------------------------------------------------------

try{
       // $Cn = new PDO('mysql:host=localhost8080; dbname=PWeb','root','');    //MYSQL
        $Cn = new PDO('pgsql:host=localhost;port=5432;dbname=pgweb;user=postgres;password=postgres');
